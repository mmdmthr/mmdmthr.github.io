...
1. Pick one small problem from a real job listing
2. Find a solution I can actually run locally
3. Implement it in my own project
4. Then go deeper into the concept
5. Write a blog post to share lesson learned for reference
